...
public class SpearmanCorrelationTest {
    ...
    private Correlation correlation = new SpearmanCorrelation();
    ...
    public void count() {
        ...
        Assert.assertEquals(-0.3, correlation.count(one, two), 0.01);
        ...
        Assert.assertEquals(0.57, correlation.count(one, two), 0.01);

        two = Arrays.asList(4.4, 4.4, 94.7, 4.4, 42.1, 70.3, 42.1, 48.1, 94.7, 42.1, 70.3);
        Assert.assertEquals(-0.005, correlation.count(one, two), 0.01);
    }
}